...
public class AddPurchaseModel {
	...
	private static final String[] labels = new String[]{"POSTAGE", "PRINTER INK", "OTHER"};
	...
	public AddPurchaseModel(Database db, String type, double amount) {
		this.db = db;
	...
	public AddPurchaseModel(Database db) {
		this(db,labels[0],0);
	...
	public void add(String type, double price, String payment) {
		
		db.sql("INSERT INTO purchases(type, amount, date, payment) "
				+ "VALUES('?', ?, '?', '?')")
